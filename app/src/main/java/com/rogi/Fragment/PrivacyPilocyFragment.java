...
public class PrivacyPilocyFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        NavigationDrawerActivity.titleText.setText(getString(R.string.nav_privacy_policy));
    ...
    private void init() {
        ...
        webView.loadUrl(Utils.MAIN_URL + Utils.PRIVACY_POLICY);
    }
}
