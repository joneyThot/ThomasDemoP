...
import com.rogi.Audio.Util;
import com.rogi.Audio.VisualizerHandler;
import com.rogi.R;
...
public class AudioRecorderActivity extends AppCompatActivity
    ...
    private TextView timerView, titleText, txtRestart, txtRecord, txtPlay;
    private ImageButton restartView;
    private ImageButton recordView;
    private ImageButton playView;
    private ImageView saveRecordView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        saveRecordView = (ImageView) findViewById(R.id.saveProfileView);
        saveRecordView.setVisibility(View.GONE);
        saveRecordView.setOnClickListener(this);
        findViewById(R.id.backLayoutclick).setOnClickListener(this);

        titleText = (TextView) findViewById(R.id.titleText);
        titleText.setText("Recorder");
    ...
    private void pauseRecording() {
        isRecording = false;
        if (!isFinishing()) {
            saveRecordView.setVisibility(View.VISIBLE);
        }
