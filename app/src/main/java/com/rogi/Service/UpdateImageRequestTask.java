...
public class UpdateImageRequestTask extends AsyncTask<String, Integer, JSONObject> {
    ...
    public UpdateImageRequestTask(Context mContext) {
    ...
    private JSONObject uploadImage(String user_id, String session_token, String project_id, String media_id, String selectedImagePath,
        ...
        try {
            Upload_Image updateImage = new Upload_Image(mContext);
            String result = updateImage.updateMedia(user_id, session_token, project_id, media_id, selectedImagePath, lat,
