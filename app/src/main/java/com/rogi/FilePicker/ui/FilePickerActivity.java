package com.rogi.FilePicker.ui;
...
import com.rogi.FilePicker.filter.CompositeFilter;
import com.rogi.FilePicker.filter.PatternFilter;
import com.rogi.FilePicker.utils.FileUtils;
import com.rogi.R;
...
public class FilePickerActivity extends AppCompatActivity implements DirectoryFragment.FileClickListener {
    ...
    private void initToolbar() {
        ...
        if (!TextUtils.isEmpty(mTitle)) {
//            setTitle(mTitle);
            getSupportActionBar().setTitle(Html.fromHtml("<font color=\"#7a1417\">" + mTitle + "</font>"));
        }
        updateTitle();
    }
    ...
    private void updateTitle() {
        if (getSupportActionBar() != null) {
            ...
            if (TextUtils.isEmpty(mTitle)) {
                getSupportActionBar().setTitle(Html.fromHtml("<font color=\"#7a1417\">" + titlePath + "</font>"));
            } else {
                getSupportActionBar().setSubtitle(Html.fromHtml("<font color=\"#7a1417\">" + titlePath + "</font>"));
            }
        }
    }
